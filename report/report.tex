...
\usepackage[st,fs,english]{packages/ethv4rl}
...
% Add your title
\title{High Accuracy Visual Inertial SLAM for Autonomous Navigation of small UAVs}
%\subtitle{bla bla bla}

% Add name of the authors
\studentA{Thomas Ziegler}
% \studentB{Student 2}
% \studentC{Student 3}

% Add name of the supervisors
\supervisionA{Marco Karrer}
\supervisionB{Patrik Schmuck}
\supervisionC{Prof. Dr. Margarita Chli}
...
\bibliography{bibliography/slamLiterature}
